...
export function ProductForm({
  ...
  const updateManufacturerField = (
    field: keyof ProductData["manufacturer"],
    value: string
  ) => {
    onProductDataChange({
      ...productData,
  ...
  const addPrecaution = () => {
    if (newPrecaution.trim()) {
      ...
      updateField("precautionaryStatements", [
        ...precautions,
        newPrecaution.trim(),
      ]);
      setNewPrecaution("");
    ...
    return (
      <div className="text-center py-8">
        <p className="text-muted-foreground">
          Veuillez d'abord sélectionner un modèle d'étiquette.
        </p>
      </div>
    );
  }
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="code">Code Produit/Lot *</Label>
              <Input
                id="code"
        ...
        <>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                {(productData?.precautionaryStatements || []).map(
                  (precaution, index) => (
                    <div
                      key={index}
                      className="flex items-center justify-between bg-muted p-2 rounded"
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateManufacturerField("name", e.target.value)
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateManufacturerField("website", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) =>
                updateManufacturerField("address", e.target.value)
              }
              rows={2}
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateManufacturerField("phone", e.target.value)
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateManufacturerField("email", e.target.value)
                }
              />
            </div>
          </div>
