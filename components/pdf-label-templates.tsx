  ...
  <View style={styles.labelContainer}>
    ...
    <View style={styles.template1Header}>
      ...
      <View style={styles.template1Logo}>
        <Text style={styles.template1LogoText}>
          BUKAVU{'\n'}PHARMAKINA
        </Text>
      </View>
    </View>
    ...
    <View style={styles.template1Content}>
      ...
      <View style={styles.template1Row}>
        ...
        <Text style={styles.template1Value}>: {formatDate(productData.manufacturingDate) || "07/2025"}</Text>
      </View>
      <View style={styles.template1Row}>
        <Text>  - Expiry date</Text>
        <Text style={styles.template1Value}>: {formatDate(productData.expiryDate) || "07/2030"}</Text>
      </View>
      <View style={styles.template1Row}>
      ...
      <View style={styles.template1Manufacturer}>
        <View style={styles.template1Row}>
          ...
          <Text style={[styles.template1Value, styles.template1ManufacturerName]}>
            {productData.manufacturer?.name || "PHARMAKINA S.A."}
          </Text>
        </View>
      ...
      <Text style={styles.template1ShippingMarks}>
        SHIPPING MARKS: --
      </Text>
...
const Template2Label: React.FC<{
  ...
  <View style={styles.labelContainer}>
    ...
    <View style={styles.template2InfoSection}>
      <Text style={styles.template2InfoTitle}>REFERENCE PHARMACOPOEAIS: BP / USP / EP / IP</Text>
      ...
      {(productData.uses || [
        ...
        <Text key={index} style={{ marginLeft: 8 }}>{use}</Text>
      ))}
    ...
    <View style={styles.template2Footer}>
      ...
      <View style={styles.template2FooterText}>
        <Text>Manufactured by {productData.manufacturer?.name || "PHARMAKINA S.A."}</Text>
        <Text>{productData.manufacturer?.address || "Km4, Route de Goma, P.O. Box 1240 BUKAVU"}</Text>
    ...
    pages.push(
      <Page key={pageIndex} size="A4" style={styles.page}>
        {Array.from({ length: labelsOnThisPage }, (_, labelIndex) => {
          const LabelComponent = template.id === 'template1' ? Template1Label : Template2Label;
          return (
            <LabelComponent
